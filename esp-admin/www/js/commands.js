var CommandType = {
  ...
  REQUEST_SAVE_WIFI_SETTINGS                  : 19,
  REQUEST_SAVE_AP_SETTINGS                    : 20,
  REQUEST_SAVE_SERIAL_SETTINGS                : 21,
  REQUEST_SAVE_SECURITY_SETTINGS              : 22,
  REQUEST_SAVE_PROTOCOLS_SETTINGS             : 23,
  REQUEST_SAVE_WEBSOCKET_CLIENT_SETTINGS      : 24,
  REQUEST_SAVE_MQTT_CLIENT_SETTINGS           : 25,
  REQUEST_SAVE_TCP_CLIENT_SETTINGS            : 26,
  REQUEST_SAVE_UDP_CLIENT_SETTINGS            : 27,
  REQUEST_SAVE_GSM_GPRS_SETTINGS              : 28,
  REQUEST_SAVE_DEVICE_CHANNELS                : 29,
  REQUEST_SAVE_DEVICE_RULES                   : 30,
  REQUEST_SAVE_MODBUS_SETTINGS                : 31,
